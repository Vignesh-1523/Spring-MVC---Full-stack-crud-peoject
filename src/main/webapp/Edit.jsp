...
<% Student s = (Student) request.getAttribute("details");  %>
       ...
       <form action="update" method="post">
        <h1>Edit</h1>
            <input type="number" placeholder="id" name="inpSno" hidden value=<%= s.getId() %>>

            <input type="text" placeholder="Username" name="inpName" autocomplete="none" value=<%= s.getName() %>>

            <input type=email placeholder="Email id" name="inpEmail" autocomplete="none" value=<%= s.getEmail() %>>

            <input type="tel" placeholder="Mobile number" name="inpMobile" autocomplete="none" value=<%= s.getMobile() %>>
 
            <input type="password" placeholder="Password" name="inpPass" autocomplete="none" value=<%= s.getPassword() %>>
